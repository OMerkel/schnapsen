...
Schnapsen ist ein Stichkartenspiel für zwei Spieler. Ziel jeder Partie ist es, durch Stiche und Ansagen von Paaren (gleichfarbiger **König + Ober**) **66 oder mehr Augen** zu erreichen.
...
Eine Hand gewinnt, wer als Erster **mindestens 66 Augen** aus Stichen und Paaransagen erreicht.
...
4. Die oberste Talonkarte wird aufgedeckt; ihre Farbe ist Trumpf.
...
- Den Stich gewinnt die höhere Karte der ausgespielten Farbe, außer es wird Trumpf gespielt; jeder Trumpf sticht jede Nicht-Trumpfkarte.
- Bei zwei Trümpfen gewinnt der höhere Trumpf.

Rangfolge im 20er Blatt (hoch nach niedrig): **Ass, Zehn, König, Ober, Unter**.

Nach jedem Stich:

1. Der Stichgewinner nimmt den Stich und spielt zum nächsten Stich aus.
2. Der Stichgewinner zieht zuerst vom Talon.
...
3. Kann nicht bedient werden, muss Trumpf gespielt werden, wenn möglich.
...
- Marriage in Nicht-Trumpf hat einen Wert von **20 Augen**.
- Trumpf-Marriage hat einen Wert von **40 Augen**.
...
- Ab dann gelten sofort die strengen Zugregeln (Farbzwang, Stichzwang, Trumpfzwang).
- Der Schließer verpflichtet sich, mit den vorhandenen Karten 66 zu erreichen; gelingt das nicht, verliert er die Hand.

## 7. Ende der Hand

Die Hand endet sofort, sobald ein Spieler **66 oder mehr Augen** erreicht und dies meldet.

Wenn niemand vor Kartenende 66 meldet:

- Alle restlichen Karten werden ausgespielt.
- Der Gewinner des letzten Stiches erhält **10 Augen Laststich-Bonus**.
- Höhere Augenzahl gewinnt die Hand.

## 8. Wertung der Hand (Spielpunkte)

Spielpunkte werden auch "Bummerl" genannt.

Übliche Wertung pro Hand:

- **1 Spielpunkt**, wenn der Verlierer 33 oder mehr Augen hat.
- **2 Spielpunkte**, wenn der Verlierer 0-32 Augen hat.
- **3 Spielpunkte**, wenn der Verlierer keinen Stich gemacht hat.

Schließt ein Spieler den Talon und erreicht nicht 66, verliert er die Hand; der Gegner erhält die Spielpunkte entsprechend derselben 1/2/3-Wertung.
...
Man macht dem Verlierer die Bummerl. In Österreich bedeutet, ein Bummerl zu haben, auch umgangssprachlich Pech zu haben oder zu verlieren.
